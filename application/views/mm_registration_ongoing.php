                    ...
                    <div class="row">
                        <div class="col-md-12 registration-content">
                            ...
                            <div class="registration-tab-content">
                                ...
                                <div class="reg-info">
                                        <p><strong>Please complete the form below if you are a returning student of the Rawḍah Madrasah (Mustafa Mount) for the year 2024-2025
                                                                                    </strong></p>
                                    </div>
                            ...
                            <!-- for mm returning / ongoing -->
                             <!-- for local -->
                                    <!-- <input type="hidden" id="class-one" name="class_ids" value="9" checked /> --> 
                            <!-- for live -->
                                    <input type="hidden" id="class-one" name="class_id" value="1" checked />
