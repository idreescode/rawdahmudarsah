                    ...
                    <div class="row">
                        <div class="col-md-12 registration-content">
                            <h2 class="section-title">Liverpool Felicity House<br>
                               <small>Returning Students Registration</small>
                                </h2>
                                <!-- <h6 class="section-sub-title">Please complete the form below</h6> -->
                           
                            <div class="registration-tab-content">
                                <div class="registration">
                                <div class="reg-info">
                                        <p><strong>Please complete the form below if you are a returning student of the Rawḍah Madrasah (Felicity House) for the year 2024-2025.</strong></p>
                                    </div>
                                    <form class="registration-tab-content" id="admission">

                       
                            <!-- for mm returning / ongoing -->
                                    <!-- <input type="hidden" id="class-one" name="class_ids" value="8" checked /> -->
                                    <input type="hidden" id="class-one" name="class_id" value="4" checked />
                                ...
                                <div class="row g-3 form-section">
                                    <div class="col-12">
                                        ...
                                        <div style="display:flex; margin:auto;">
                                            ...
                                            <div class="g-recaptcha" style="display:flex; margin:auto;" data-sitekey="6LdSSfAqAAAAABTh_aUc0ycQ17dZuqMl3qGLfpM4"></div>
                                        </div>
...
<script>
    ...
    $(function() {
        ...
        // });
        var minDate = new Date(2017, 7, 31); // 31st August 2017
    var maxDate = new Date(2011, 6, 30); // 30th July 2016
